...
public final class QLog {
    ...
    public static final byte ERRORS_ONLY = 1;
    public static final byte ERRORS_WARNINGS = 2;
    public static final byte ERRORS_WARNINGS_INFO = 3;
    public static final byte ERRORS_WARNINGS_INFO_DEBUG = 4;
    public static final byte ALL = 5;
    public static byte LOGGING_LEVEL = ALL;
...
//    }
    ...
    public static void e(final String tag, final Object obj, final Throwable cause) {
        if (isELoggable()) {
            Log.e(tag, getTrace() + getThrowableTrace(cause) + String.valueOf(obj));
        }
    }
